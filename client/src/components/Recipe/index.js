...
function Recipe(){
    ...
    <Carousel>
      ...
      <Carousel.Item>
        <Card style={{ width: '30rem' }}>
        <Card.Img variant="top" src="https://images.unsplash.com/photo-1643226228323-34e639efc40e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDk5fHhqUFI0aGxrQkdBfHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=400&q=60" />
        <Card.Body>
          <Card.Title>Recipe Title</Card.Title>
          <Card.Text>
            Recipe
